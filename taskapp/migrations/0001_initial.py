# Generated by Django 2.2 on 2020-03-22 05:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Автор тега')),
            ],
        ),
        migrations.CreateModel(
            name='Taskapp',
            fields=[
                ...
                ('status', models.IntegerField(choices=[(2, 'В ожидании'), (3, 'Законченный'), (1, 'В процессе')], default=2, verbose_name='Статус')),
